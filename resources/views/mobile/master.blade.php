...
<section id="menu_konta" class=" layer-more visible">
    <div id="menu_konta_cien" class=""></div>
    <div class="bottom-sheet">
        <div class="static-dismiss-field">
        </div>
        <ul class="menu-list"><!---->
            <li>
                <a redirect='true' href="{{route('mobile.login')}}" class="icon">
                    <div class="thumbnail">
            ...
            <li>
                ...
                <a redirect='true' href="/register1" container="true" class="icon" id="logowanie">
                    <div class="thumbnail"><i class="bottom-sheet-icn settings"></i></div>
                    Zarejestruj się
                </a></li>
            <li class="divider"></li>
            <li><a href="javascript:void(0)" class="icon">
                    <div class="thumbnail"><i class="bottom-sheet-icn dark-mode"></i></div>
                    Dark mode
                    <div class="switch"></div>
                    <div class="switch-btn"></div>
                </a></li>
            <li class="pro-section"><a href="javascript:void(0)" class="icon">
                    <div class="thumbnail"><i class="icn phone-000"></i></div>
                </a>
            </li>
