                ...
                <div class="col-lg-8">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                What do you y'all think? Would love some feedback from <a href="#!" class="badge badge-soft-primary">@Marinela</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto d-flex align-items-center">
                                    <a href="#" class="mdi mr-2 mdi-24px mdi-bookmark-outline opacity-75 align-middle"></a>
                                    <div class="avatar-group">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <ul class="list-unstyled">
                                    ...
                                    <li class="media">
                                        <div class="avatar mr-3  avatar-sm">
                                            <img src="assets/img/users/user-7.jpg" alt="..." class="avatar-img rounded-circle">
                                        </div>
                                        <div class="media-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto d-flex align-items-center">
                                    ...
                                    <div class="avatar-group">
                                        ...
                                        <div class="avatar avatar-xs">
                                            <img src="assets/img/users/user-9.jpg" alt="..." class="avatar-img rounded-circle">
                                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="list-group list  list-group-flush">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle" src="assets/img/users/user-4.jpg" alt="user4"></div>
                                </div>
                                <div class="">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle" src="assets/img/users/user-8.jpg" alt="user"></div>
                                </div>
                                <div class="">
