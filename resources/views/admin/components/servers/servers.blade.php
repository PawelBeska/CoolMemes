            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Zarządzanie serwerami</h5>
                        <p>Za pomocą tego formularza można dodawać nowe serwery do serwisu.</p>
                        {!! Form::open(['class'=>'create needs-validation','novalidate','url'=>route('admin.servers.create')]) !!}
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                {!! Form::label('name','Nazwa serwera:') !!}
